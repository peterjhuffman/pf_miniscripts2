...
#        print(dfr.columns)
        ...
        if SAVE:
            plt.savefig(path+f'pulls\\{tg}_line{tag}.png',dpi=200)
#        plt.show()
        plt.clf()
        ...
        if SAVE:
            plt.savefig(path+f'pulls\\{tg}_heat{tag}.png',dpi=200, bbox_inches='tight')
#        plt.show()
        plt.clf()
        ...
        plt.xticks([i-1 for i in range(1, len(dfscells)+1)], dfscells, rotation=90)
        if SAVE:
            plt.savefig(path+f'pulls\\{tg}_heatn{tag}.png',dpi=200, bbox_inches='tight')
#        plt.show()
        plt.clf()
        ...
        if SAVE:
            plt.savefig(path+f'pulls\\{tg}_pca{tag}.png',dpi=200)
#        plt.show()
        plt.clf()
        ...
        if SAVE:
            plt.savefig(path+f'pulls\\{tg}_heatar{tag}.png',dpi=200, bbox_inches='tight')
        plt.show()
        plt.clf()
