...
df.loc[df['Gene'].isin(itxome_p)&mask_p&either_mask, 'color'] = 'itx_p'
print(f"{df.loc[df['Gene'].isin(itxome_p)&mask_p&either_mask].shape[0]} significant predicted substrates identified through MS.")

df.loc[df['Gene'].isin(itxome)&mask_p&either_mask, 'color'] = 'itx'
print(f"{df.loc[df['Gene'].isin(itxome)&mask_p&either_mask].shape[0]} significant substrates identified through MS.")
